...
const ProductCard = ({item}) => {
  ...
  return (
    <div className="flex flex-col justify-between gap-6 p-4 rounded-lg shadow-[var(--shadow-custom)] w-full h-full bg-white border border-transparent hover:border-[var(--primary)] transition">
